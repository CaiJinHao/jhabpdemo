...
using MyDemo.Blazor.Server.Host.Menus;
...
[DependsOn(
    ...
    typeof(MyDemoBlazorServerModule)
)]
public class MyDemoBlazorHostModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
        {
            options.AddAssemblyResource(
                typeof(MyDemoResource),
                typeof(MyDemoDomainModule).Assembly,
                typeof(MyDemoDomainSharedModule).Assembly,
                typeof(MyDemoApplicationModule).Assembly,
                typeof(MyDemoApplicationContractsModule).Assembly,
                typeof(MyDemoBlazorHostModule).Assembly
            );
        });
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        Configure<AbpBundlingOptions>(options =>
        {
                ...
                bundle =>
                {
                    bundle.AddFiles("/blazor-global-styles.css");
                        ...
                        bundle.AddFiles("/MyDemo.Blazor.Server.Host.styles.css");
                }
            );
        });
        ...
        if (hostingEnvironment.IsDevelopment())
        {
            Configure<AbpVirtualFileSystemOptions>(options =>
            {
                ...
                options.FileSets.ReplaceEmbeddedByPhysical<MyDemoBlazorHostModule>(hostingEnvironment.ContentRootPath);
            });
        }
        ...
        {
            options.AppAssembly = typeof(MyDemoBlazorHostModule).Assembly;
        });
    ...
    public async override Task OnApplicationInitializationAsync(ApplicationInitializationContext context)
    {
        ...
        {
            options.SwaggerEndpoint("/swagger/v1/swagger.json", "MyDemo API");
        });
